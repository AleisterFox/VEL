    ...
    <main>
        ...
        <section id="servicios">
            <div class="bg" style="opacity: 0.2;">
                <figure>
                    <img src="img/modulos-bg.jpg" alt="">
                </figure>
            </div>

            <div class="container">
                <div class="servicio modulo">
                    <div class="titulo">
                        <h3>P-18 Modules</h3>
                    </div>
                    <div class="contenido">
                        <div class="left">
                            ...
                            <ul class="especificaciones">
                                <li>Virgin AC CTC60</li>
                                <li>KMnO4 (Potassium Perm) 8%</li>
                                <li>50/50, 60/40, 70/30, Blends</li>
                                <li>MgO 10% (H2S)</li>
                                <li>KOH 10% (H2S)</li>
                            </ul>
                            <a href="PDFs/VEL Modules.pdf" target="__blank" class="button">Data Sheet</a>
                        </div>
                        <div class="right">
                            <figure>
