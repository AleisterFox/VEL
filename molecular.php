    ...
    <main>
        <section id="hero">
            ...
            <div class="texto">
                <div class="linea"></div>
                <div class="title">
                    <h1>MOLECULAR MEDIA</h1>
                </div>
                <div class="logo-fondo">
                    <figure><img src="img/logo-fondo.png" alt=""></figure>
                </div>
                <div class="paragraph">
                    <p>We provide branding and supply solutions to OEMS, BIOGAS, RNG, Service suppliers, and large consumers. We offer an extensive family of chemical media products for the right application.</p>
                </div>
                <div class="linea"></div>
            </div>
        </section>
        ...
        <section id="products__table">
            ...
            <table>
                <thead>
                    <tr>
                        <th colspan="2">Activated Carbon Media</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
            ...
            <table>
                <thead>
                    <tr>
                        <th colspan="2">Impregnated Activated Alumina Media</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
            ...
            <table>
                <thead>
                    <tr>
                        <th colspan="2">Special application Media</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
